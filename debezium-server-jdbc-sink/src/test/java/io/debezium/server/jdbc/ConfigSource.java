...
public class ConfigSource extends TestConfigSource {
  ...
  public ConfigSource() {
    ...
    config.put("debezium.sink.jdbc.upsert", "false");
    config.put("debezium.sink.jdbc.upsert-keep-deletes", "true");
    config.put("debezium.sink.jdbc.database.schema", TARGET_SCHEMA);
    config.put("debezium.sink.jdbc.table-prefix", "debeziumcdc_");
