...
import io.debezium.server.jdbc.testresources.TargetMysqlDB;
 ...
 */
@QuarkusTest
@QuarkusTestResource(TargetMysqlDB.class)
public class JdbcChangeConsumerSimpleMysqlTest extends BaseDbTest {
  @Inject
